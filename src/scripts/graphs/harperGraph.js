var harper = require('../../data/harper_data.json');
...
window.addEventListener('DOMContentLoaded', e => {
    ...
    let svg = d3.select('#harper-graph');
    ...
    function updateCheckbox() {
        d3.selectAll('.checkbox.harper').each(function(d) {
        ...
        d3.selectAll('.harper').on('change',updateCheckbox)
    }
