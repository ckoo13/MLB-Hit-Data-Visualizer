var freeman = require('../../data/freeman_data.json');
...
window.addEventListener('DOMContentLoaded', e => {
    ...
    let svg = d3.select('#freeman-graph');
    ...
    function updateCheckbox() {
        d3.selectAll('.checkbox.freeman').each(function(d) {
        ...
        d3.selectAll('.freeman').on('change',updateCheckbox)
    }
