var altuve = require('../../data/altuve_data.json');
...
window.addEventListener('DOMContentLoaded', e => {
    ...
    let svg = d3.select('#altuve-graph');
    ...
    function updateCheckbox() {
        d3.selectAll('.checkbox.altuve').each(function(d) {
        ...
        d3.selectAll('.altuve').on('change',updateCheckbox)
    }
