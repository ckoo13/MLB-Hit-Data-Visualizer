var judge = require('../../data/judge_data.json');
...
window.addEventListener('DOMContentLoaded', e => {
    ...
    function updateCheckbox() {
        d3.selectAll('.checkbox.judge').each(function(d) {
        ...
        d3.selectAll('.judge').on('change',updateCheckbox)
    }
