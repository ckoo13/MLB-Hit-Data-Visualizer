var ohtani = require('../../data/ohtani_data.json');
...
window.addEventListener('DOMContentLoaded', e => {
    ...
    let svg = d3.select('#ohtani-graph');
    ...
    function updateCheckbox() {
        d3.selectAll('.checkbox.ohtani').each(function(d) {
        ...
        d3.selectAll('.ohtani').on('change',updateCheckbox)
    }
