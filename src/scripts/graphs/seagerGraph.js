var seager = require('../../data/seager_data.json');
...
window.addEventListener('DOMContentLoaded', e => {
    ...
    let svg = d3.select('#seager-graph');
    ...
    function updateCheckbox() {
        d3.selectAll('.checkbox.seager').each(function(d) {
        ...
        d3.selectAll('.seager').on('change',updateCheckbox)
    }
