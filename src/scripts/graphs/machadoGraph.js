var machado = require('../../data/machado_data.json');
...
window.addEventListener('DOMContentLoaded', e => {
    ...
    let svg = d3.select('#machado-graph');
    ...
    function updateCheckbox() {
        d3.selectAll('.checkbox.machado').each(function(d) {
        ...
        d3.selectAll('.machado').on('change',updateCheckbox)
    }
